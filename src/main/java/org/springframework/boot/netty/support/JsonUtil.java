...
import org.springframework.boot.autoconfigure.netty.test.User;
...
public class JsonUtil {
    ...
    public static <T> String obj2String(T obj){
        ...
        try {
            ...
            throw new ConvertException("can not converter for :"+obj);
        }
    }
    ...
    public static <T> T string2Obj(String str,Class<T> clazz){
        ...
        try {
            ...
            e.printStackTrace();
            throw new ConvertException("can not converter for :"+str);
        }
    }
    ...
    public static void main(String[] args) {
        ...
        User user = string2Obj(content, User.class);
