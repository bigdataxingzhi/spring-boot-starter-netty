 ...
 */
public class AbstractChannelInboundHandlerAdapter extends ChannelInboundHandlerAdapter {
    ...
    private final static Logger logger = LoggerFactory.getLogger(AbstractChannelInboundHandlerAdapter.class);
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        MessageBlockQueue.setMessage(partition,new Message<String>(currentChannel, (String) msg,partition));
